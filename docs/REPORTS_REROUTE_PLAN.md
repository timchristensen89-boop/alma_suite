...
- Remaining (#7 raw-line COGS, #9 Square mapping) per table below — next.

**Tally: 10 of 13 done** (dashboard + #1,#2,#3,#4,#5,#6,#8,#10,#11–13), **2 to go** (#7, #9). Verified end-to-end on embedded Postgres via `verify-dashboard-stock-parity.ts`.
