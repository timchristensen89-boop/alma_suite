...
const ADMIN_HANDOFF_LINKS = [
  // Tip payments (the ABA bank file settings) used to be a tab on this page.
  // Admin has the same settings plus the funding-accounts list this page never
  // grew, so the tab is gone and this points at the one that is complete.
  { label: 'Tip payments (ABA file)', href: '/staff-settings' },
